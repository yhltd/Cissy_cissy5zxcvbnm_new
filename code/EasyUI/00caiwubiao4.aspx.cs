...
namespace EasyUI
{
    public partial class _0caiwubiao4 : System.Web.UI.Page
    {
            ...
            if (workbook != null)
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < sheet.LastRowNum; i++)
                    {
                        ...
                        string sqlStr = "update Sale set star='" + row.GetCell(2) + "'where name='" + row.GetCell(0) + "'and sunSKU='" + row.GetCell(1) + "'";
