...
namespace EasyUI
{
    public partial class _01xiaoshoubiao2 : System.Web.UI.Page
    {
            ...
            if (workbook != null)
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < sheet.LastRowNum; i++)
                    {
                        ...
                        string sqlStr = "update Trial set FBA='" + row.GetCell(4) + "',three= '" + row.GetCell(5) + "',thirty= '" + row.GetCell(6) + "' where name='" + row.GetCell(3) + "' and no = '" + row.GetCell(1) + "' and num = '"+ row.GetCell(2) + "'" ;
