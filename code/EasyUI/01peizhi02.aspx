<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="01peizhi02.aspx.cs" Inherits="EasyUI._01Peizhi02" %>--%>
<%@ Page Language="C#" AutoEventWireup="true" Inherits="EasyUI._01Peizhi02"  EnableEventValidation = "false"  CodeBehind="01peizhi02.aspx.cs" %>
...
<head>
    ...
    <script src="/dataPage/peizhi02.js" type="text/javascript"></script>
</head>
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
    ...
    <div id="Dlg-Edit" title="编辑窗口" style="width: 809px; height: 243px;">
        <div style="padding: 20px 20px 40px 40px;">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <text class="easyui-validatebox" style="width: 150px;">扣除比例为0</text>
                    </td>
                    <td>
                        冗余31-90天扣除比例：
                    </td>
                    <td>
                        <input name="betw3190" class="easyui-validatebox" required="true" style="width: 150px;" />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input name="betw91180" class="easyui-validatebox" required="true" style="width: 150px;" />
                    </td>
                    <td>
                        冗余180天及以上扣除比例：
                    </td>
                    <td>
                        <input name="over181" class="easyui-validatebox" required="true" style="width: 150px;" />
                    </td>
   ...
   <div id="search-window" title="查询窗口" style="width: 412px; height: 200px;">
