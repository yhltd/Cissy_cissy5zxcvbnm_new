...
(function ($) {
    ...
    function _d(_e) {
        ...
        cc.find(">div").each(function () {
            ...
            _f.push(pp);
            pp.panel({
                collapsible: true, minimizable: false, maximizable: false, closable: false, doSize: false, collapsed: pp.attr("selected") != "true", onBeforeExpand: function () {
                    var _10 = _9(_e);
                    if (_10) {
...
(function ($) {
    ...
    function _4f(_50, url) {
        ...
        $.ajax({
            url: _51.url, dataType: "json", success: function (_52) {
                _49(_50, _52);
    ...
    $.fn.combobox.defaults = {
        width: "auto", listWidth: null, listHeight: null, valueField: "value", textField: "text", editable: true, url: null, onLoadSuccess: function () {
...
(function ($) {
    function _60(_61) {
        ...
        _64.find(">ul").tree({
            url: _62.url, onClick: function (_67) {
    ...
    $.fn.combotree.defaults = {
        width: "auto", treeWidth: null, treeHeight: 200, url: null, onSelect: function (_85) {
...
(function ($) {
    ...
    function _a2(_a3) {
        ...
        $(".datagrid-header .datagrid-cell", _a4).resizable({
        ...
        $(".datagrid-view1 .datagrid-header .datagrid-cell", _a4).resizable({
            onStopResize: function (e) {
                _9d(_a3, this);
                $(".datagrid-view2 .datagrid-header", _a4).scrollLeft($(".datagrid-view2 .datagrid-body", _a4).scrollLeft());
                $(".datagrid-resize-proxy", _a4).css("display", "none");
    ...
    function _101(_102) {
        ...
        $.ajax({
            type: opts.method, url: opts.url, data: _103, dataType: "json", success: function (data) {
    ...
    $.fn.datagrid = function (_104, _105) {
        ...
        return this.each(function () {
            ...
            if (opts.pagination) {
                ...
                _10a.pagination({
                    pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_10b, _10c) {
...
(function ($) {
    ...
    function _119(_11a) {
        ...
        $(_11a).window($.extend({}, opts, {
            onResize: function (_11f, _120) {
...
(function ($) {
    ...
    $.fn.draggable.defaults = {
        handle: null, disabled: false, edge: 0, axis: null, onStartDrag: function (e) {
        }, onDrag: function (e) {
    ...
    function init(_152) {
        ...
        function _153(dir) {
            ...
            if (pp.attr("split") == "true") {
                ...
                _155.resizable({
                    handles: _156, onStartResize: function (e) {
                        _149 = true;
...
(function ($) {
    ...
    function _187(_188, _189, _18a) {
        ...
        win.window({
            title: _188, width: 300, height: "auto", modal: true, collapsible: false, minimizable: false, maximizable: false, resizable: false, onClose: function () {
                setTimeout(function () {
                    win.window("destroy");
                }, 100);
            }
...
(function ($) {
    ...
    $.fn.pagination.defaults = {
        total: 1, pageSize: 10, pageNumber: 1, pageList: [10, 20, 30, 50], loading: false, buttons: null, onSelectPage: function (_1a7, _1a8) {
...
(function ($) {
    ...
    function _251(_25f, ul, _260) {
        ...
        $.ajax({
            type: "post", url: opts.url, data: _260, dataType: "json", success: function (data) {
    ...
    $.fn.tree.defaults = {
        url: null, animate: false, onLoadSuccess: function () {
        }, onLoadError: function () {
...
(function ($) {
    ...
    function init(_287, _288) {
        ...
        var win = $(_287).panel($.extend({}, opts, {
    ...
    function _297(_298) {
        ...
        _299.window.draggable({
            handle: ">div.panel-header>div.panel-title", disabled: _299.options.draggable == false, onStartDrag: function (e) {
                if (_299.mask) {
