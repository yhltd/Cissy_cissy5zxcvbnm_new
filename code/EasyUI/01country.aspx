<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="01country.aspx.cs" Inherits="EasyUI._01country" %>
...
<head>
    ...
    <script src="/dataPage/country.js" type="text/javascript"></script>
    <style type="text/css">
        #Button2 {
            width: 195px;
            height: 39px;
            ...
            <form method="post">
                <table>
                    <tr>
                        ...
                        <td>
                            <input name="country" class="easyui-validatebox" required="true" style="width: 150px;" />
                        </td>
                    </tr>
                </table>
            </form>
