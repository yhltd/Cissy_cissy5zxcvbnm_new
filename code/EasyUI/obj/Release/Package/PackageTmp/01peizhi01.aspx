<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="01peizhi01.aspx.cs" Inherits="EasyUI._01peizhi" %>--%>
<%@ Page Language="C#" AutoEventWireup="true" Inherits="EasyUI._01peizhi"  EnableEventValidation = "false"  CodeBehind="01peizhi01.aspx.cs" %>
...
<head>
    ...
    <script src="/dataPage/peizhi01.js" type="text/javascript"></script>
</head>
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
    ...
    <div id="Dlg-Edit" title="编辑窗口" style="width: 558px; height: 233px;">
        <div style="padding: 20px 20px 40px 40px;">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <input name="star" class="easyui-validatebox" required="true" style="width: 150px;" />
                    </td>
                    <td>
                        相乘比例：
                    </td>
                    <td>
                        <input name="rate1" class="easyui-validatebox" required="true" style="width: 150px;" />
                    </td>
                </tr>
            </table>
            </form>
