<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="01xiaoshouqingkuang.aspx.cs" Inherits="EasyUI._01xiaoshouqingkuang" %>--%>
<%@ Page Language="C#" AutoEventWireup="true" Inherits="EasyUI._01xiaoshouqingkuang"  EnableEventValidation = "false"  CodeBehind="01xiaoshouqingkuang.aspx.cs" %>
...
<head>
    ...
    <script src="/dataPage/xiaoshouqingkuang.js" type="text/javascript"></script>
    <style type="text/css">
        #Button2 {
            height: 51px;
            width: 154px;
