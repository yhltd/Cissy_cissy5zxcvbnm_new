<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="01xiaoshouqiangkuang1.aspx.cs" Inherits="EasyUI._01xiaoshouqiangkuang1" %>--%>
<%@ Page Language="C#" AutoEventWireup="true" Inherits="EasyUI._01xiaoshouqiangkuang1"  EnableEventValidation = "false"  CodeBehind="01xiaoshouqiangkuang1.aspx.cs" %>
...
<head>
    ...
    <script src="/dataPage/xiaoshouqingkuang1.js" type="text/javascript"></script>
    <style type="text/css">
        #Button2 {
            height: 51px;
            width: 154px;
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
   ...
   <div id="search-window" title="查询窗口" style="width: 443px; height: 200px;">
...
GROUP BY
Sales.city,Sales.sunSKU"></asp:SqlDataSource>
