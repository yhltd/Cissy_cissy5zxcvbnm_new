...
(function ($) {
    ...
    $.fn.draggable.defaults = {
        proxy: null, revert: false, cursor: "move", deltaX: null, deltaY: null, handle: null, disabled: false, edge: 0, axis: null, onStartDrag: function (e) {
        }, onDrag: function (e) {
...
(function ($) {
    ...
    $.fn.droppable.defaults = {
        accept: null, onDragEnter: function (e, _2e) {
...
(function ($) {
    ...
    $.fn.pagination.defaults = {
        total: 1, pageSize: 10, pageNumber: 1, pageList: [10, 20, 30, 50], loading: false, buttons: null, showPageList: true, showRefresh: true, onSelectPage: function (_75, _76) {
...
(function ($) {
    ...
    function _8d(_8e) {
        ...
        _90.find("div.tree-node").draggable({
            revert: true, cursor: "pointer", proxy: function (_91) {
    ...
    function _ce(_cf, ul, _d0, _d1) {
        ...
        $.ajax({
            type: _d2.method, url: _d2.url, data: _d0, dataType: "json", success: function (_d6) {
    ...
    $.fn.tree.defaults = {
        url: null, method: "post", animate: false, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, dnd: false, data: null, onBeforeLoad: function (node, _13d) {
...
(function ($) {
    $.parser = {
        auto: true, onComplete: function (_142) {
...
(function ($) {
    ...
    function _19a(_19b) {
        ...
        var win = $(_19b).panel($.extend({}, _19c.options, {
            border: false, doSize: true, closed: true, cls: "window", headerCls: "window-header", bodyCls: "window-body", onBeforeDestroy: function () {
    ...
    function _1a2(_1a3) {
        ...
        _1a4.window.draggable({
            handle: ">div.panel-header>div.panel-title", disabled: _1a4.options.draggable == false, onStartDrag: function (e) {
                if (_1a4.mask) {
        ...
        _1a4.window.resizable({
            disabled: _1a4.options.resizable == false, onStartResize: function (e) {
                if (!_1a4.proxy) {
                    _1a4.proxy = $("<div class=\"window-proxy\"></div>").insertAfter(_1a4.window);
                }
...
(function ($) {
    ...
    function _1b1(_1b2) {
        ...
        var _1b7 = opts.href;
        opts.href = null;
        $(_1b2).window($.extend({}, opts, {
            onResize: function (_1b8, _1b9) {
...
(function ($) {
    ...
    function _1ca(_1cb, _1cc, _1cd) {
        ...
        win.window({
            title: _1cb, width: 300, height: "auto", modal: true, collapsible: false, minimizable: false, maximizable: false, resizable: false, onClose: function () {
                setTimeout(function () {
                    win.window("destroy");
                }, 100);
            }
...
(function ($) {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, onSelect: function (_207) {
        }, onAdd: function (_208) {
...
(function ($) {
    ...
    function _234(_235, pp, _236) {
        _236 = _236 || {};
        pp.panel($.extend({}, { selected: pp.attr("selected") == "true" }, _236, {
            border: false, noheader: true, closed: true, doSize: false, iconCls: (_236.icon ? _236.icon : undefined), onLoad: function () {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", plain: false, fit: false, border: true, tools: null, scrollIncrement: 100, scrollDuration: 400, onLoad: function (_264) {
    ...
    function init(_274) {
        ...
        function _275(dir) {
            ...
            if (pp.attr("split") == "true") {
                ...
                _277.resizable({
                    handles: _278, onStartResize: function (e) {
                        _26b = true;
...
(function ($) {
    ...
    function load(_2dd, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _2de, dataType: "json", success: function (data) {
                    _2df(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.calendar.defaults = {
        width: 180, height: 180, fit: false, border: true, weeks: ["S", "M", "T", "W", "T", "F", "S"], months: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], year: new Date().getFullYear(), month: new Date().getMonth() + 1, current: new Date(), onSelect: function (date) {
        }
    };
})(jQuery);
(function ($) {
    function init(_31d) {
        ...
        _31e.find("div.datebox-calendar-inner>div").calendar({
    ...
    $.fn.datebox.defaults = $.extend({}, $.fn.validatebox.defaults, {
        currentText: "Today", closeText: "Close", disabled: false, formatter: function (date) {
...
(function ($) {
    ...
    function _39b(_39c) {
        ...
        _39d.panel($.extend({}, opts, {
            doSize: false, onResize: function (_39e, _39f) {
                setTimeout(function () {
                    _375(_39c);
                    _3c6(_39c);
        ...
        if (opts.pagination) {
            ...
            _3a3.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_3a4, _3a5) {
    ...
    function _3b5(_3b6) {
        ...
        _3b8.find("div.datagrid-cell").resizable({
            handles: "e", minWidth: 25, onStartResize: function (e) {
        ...
        $("div.datagrid-view1 div.datagrid-header div.datagrid-cell", _3b7).resizable({
            onStopResize: function (e) {
    ...
    function _46d(_46e, _46f) {
        ...
        function _473() {
            $.ajax({
                type: opts.method, url: opts.url, data: _471, dataType: "json", success: function (data) {
                    setTimeout(function () {
                        _474();
                    }, 0);
                    _3e7(_46e, data);
    ...
    var _4e0 = {
        render: function (_4e1, _4e2, _4e3) {
...
(function ($) {
    function _50a(_50b) {
        ...
        $(_50b).datagrid($.extend({}, opts, {
            url: null, onLoadSuccess: function () {
    ...
    function _54f(_550, _551, _552, _553, _554) {
        ...
        $.ajax({
            type: opts.method, url: opts.url, data: _555, dataType: "json", success: function (data) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, animate: false, singleSelect: true, onBeforeLoad: function (row, _59f) {
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.validatebox.defaults, {
        width: "auto", panelWidth: null, panelHeight: 200, multiple: false, separator: ",", editable: true, disabled: false, value: "", keyHandler: {
            up: function () {
            }, down: function () {
            }, enter: function () {
            }, query: function (q) {
...
(function ($) {
    ...
    function _608(_609, url, _60a, _60b) {
        ...
        _60a = _60a || {};
        $.ajax({
            url: opts.url, dataType: "json", data: _60a, success: function (data) {
                _603(_609, data, _60b);
            }, error: function () {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", mode: "local", url: null, data: null, keyHandler: {
            up: function () {
                _5ea(this);
            }, down: function () {
                _5f0(this);
