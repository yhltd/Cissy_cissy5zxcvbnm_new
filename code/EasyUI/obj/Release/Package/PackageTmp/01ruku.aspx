<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="01ruku.aspx.cs" Inherits="EasyUI.shengchengbiao1" %>--%>
<%@ Page Language="C#" AutoEventWireup="true" Inherits="EasyUI.shengchengbiao1"  EnableEventValidation = "false"  CodeBehind="01ruku.aspx.cs" %>
...
<head>
    ...
    <script src="/dataPage/ruku.js" type="text/javascript"></script>
</head>
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
   ...
   <div id="search-window" title="查询窗口" style="width: 448px; height: 200px;">
