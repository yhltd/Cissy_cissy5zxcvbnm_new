<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="01xiaoshouqingkuang3.aspx.cs" Inherits="EasyUI._01xiaoshouqingkuang3" %>--%>
<%@ Page Language="C#" AutoEventWireup="true" Inherits="EasyUI._01xiaoshouqingkuang3"  EnableEventValidation = "false"  CodeBehind="01xiaoshouqingkuang3.aspx.cs" %>
...
<head>
    ...
    <script src="/dataPage/xiaoshouqingkuang3.js" type="text/javascript"></script>
    <style type="text/css">
        #Button2 {
            height: 51px;
            width: 154px;
        ...
        <div style="padding: 20px 20px 40px 80px;">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input name="s_titlee" id="s_titlee" style="width: 150px;" />
                    </td>
                </tr>
            </table>
            </form>
            ...
            <div style="padding: 20px 20px 40px 80px; text-align: center; margin-left: 40px;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="901px" style="margin-left: 0px; margin-top: 36px">
                    <Columns>
                        ...
                        <asp:BoundField DataField="退货数量" HeaderText="退货数量" ReadOnly="True" SortExpression="退货数量" />
...
GROUP BY Sales.account,Sales.sunSKU"></asp:SqlDataSource>
