...
//    searchForm = searchWin.find('form');
    ...
    grid = $('#grid').datagrid({
        ...
        url: 'Handler.ashx?action=list&ran='+Math.random(),  //从远程站点请求数据的 URL
        ...
        columns: [[
					{ field: 'Column1', title: '起止年月', width: 100 }, //fieldfield 列的字段名,title列的标题文字,sortable 是否允许此列被排序
					{field: 'Column2', title: '工作单位及职务', width: 150, sortable: true }, 
                    { field: 'Column3', title: '职级', width: 150}
